...
class MoneyConfigProvide {

    private File playerDataFolder;

    private MoneyConfigProvide(@NotNull EconomyAPI plugin) {
    ...
    public static MoneyConfigProvide getInstance(EconomyAPI plugin) {
        return new MoneyConfigProvide(plugin);
    }
